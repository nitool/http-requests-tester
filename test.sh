...
node http-requests-tester --selected-client test --client-file rest-client.env.json \
./tests/functional/test_case_with_variables.http \
 ./tests/functional/test_case_with_variables.http \
 ./tests/functional/test_case_flow.http \
 ./tests/functional/test_case_without_headers.http \
 ./tests/functional/test_case_with_external_script.http \
 ./tests/functional/test_case_with_dynamic.http \
 ./tests/functional/test_case_with_body_from_file.http \
 ./tests/functional/test_case_with_form_data.http \
 ./tests/functional/test_case_annotations.http \
 ./tests/functional/test_case_flow.http \
 ./tests/functional/test_case_flow_2.http \
 ./tests/functional/test_case_with_errors.http
